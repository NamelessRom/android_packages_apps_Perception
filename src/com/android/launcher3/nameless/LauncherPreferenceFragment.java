...
public class LauncherPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    private SwitchPreference mTransparentBackground;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTransparentBackground = (SwitchPreference) findPreference(
                SettingsProvider.SETTINGS_UI_DRAWER_BACKGROUND_TRANSPARENT);
        mTransparentBackground
                .setChecked(!mLauncher.getAppsCustomizeContent().isBackgroundVisible());
        mTransparentBackground.setOnPreferenceChangeListener(this);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference instanceof ListPreference) {
            ...
            return true;
        } else if (mTransparentBackground == preference) {
            final boolean value = (Boolean) newValue;
            mLauncher.getAppsCustomizeContent().setBackgroundVisible(!value);
            return true;
        }
